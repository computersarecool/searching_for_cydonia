...
public class ExampleWheelController : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKey (KeyCode.UpArrow)) // Rotate forwardMovement
            m_Rigidbody.AddRelativeTorque(new Vector3(-1 * acceleration, 0, 0), ForceMode.Acceleration); // Add forwardMovement torque to mesh
